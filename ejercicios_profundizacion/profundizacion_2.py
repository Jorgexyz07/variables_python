...
print("Ingrese su número de DNI sin puntos")
dni = int(input())
print("Ingrese su edad")
edad = int(input())
print("Ingrese su altura. Utilice . para separar la parte entera de la decimal")
altura = float(input())
print("Nombre Completo:", nombre_completo, ", DIN:", dni)
print ("")
